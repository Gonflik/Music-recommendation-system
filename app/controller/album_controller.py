...
from app.model.action import ActionName
...
def album_show(album_id):
    ...
    Action.create_or_increment(name=ActionName.ALBUM_SHOW ,user_id=current_user.id, reference_id=album_id, reference_name="album")
