...
with app.app_context():
    ...
    song = Song(name="Pork",length=123,genre="Piggy-rock", album_id=1, artist_id=1)
    album2 = Album(name="John Pork is dead...", artist_id=1)
    song2 = Song(name="Decaying",length=5252,genre="Piggy-sad-rock", album_id=2, artist_id=1)
